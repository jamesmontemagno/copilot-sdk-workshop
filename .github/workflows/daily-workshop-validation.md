...
local assets and language propagation tests, the accessibility starter, all finished projects,
and the Blazor target. It uses deterministic noninteractive commands only.
